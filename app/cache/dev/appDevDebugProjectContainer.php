...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tyre', 'user' => 'root', 'password' => 'spaces', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_6d67326e810aff6303c75ad1131b4453b3cb93f91424caac30eb0d1095c92f83');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6d67326e810aff6303c75ad1131b4453b3cb93f91424caac30eb0d1095c92f83');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6d67326e810aff6303c75ad1131b4453b3cb93f91424caac30eb0d1095c92f83');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(__DIR__.'/../../../src/Tyre/TyreBundle/Resources/config/doctrine' => 'Tyre\\TyreBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Tyre\\TyreBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('TyreTyreBundle' => 'Tyre\\TyreBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(__DIR__.'/../../../src/Tyre/TyreBundle/Resources/views', 'TyreTyre');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TyreTyreBundle' => 'Tyre\\TyreBundle\\TyreTyreBundle',
            ...
            'assetic.ruby.bin' => '/home/smiles/.rvm/rubies/ruby-2.1.2/bin/ruby',
            'assetic.sass.bin' => '/home/smiles/.rvm/gems/ruby-2.1.2/bin/sass',
